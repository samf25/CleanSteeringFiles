...
def new_ECalBarrelDigi():
    ...
    """
    return RealisticCaloDigiSilicon("ECalBarrelDigi",
...
def new ECalBarrelReco():
    """
    Create a new ECal barrel reco instance with the given parameters.
    """
    return RealisticCaloRecoSilicon("ECalBarrelReco",
...
def new_ECalPlugDigi():
    ...
    """
    return RealisticCaloDigiSilicon("ECalPlugDigi",
                                    calibration_mip = 0.0001575,
                                    threshold = 5e-05,
                                    thresholdUnit = "GeV",
                                    timingCorrectForPropagation = 1,
...
def new_ECalPlugReco():
    ...
    """
    return RealisticCaloRecoSilicon("ECalPlugReco",
                                    calibration_factorsMipGev = [0.00641222630095],
                                    calibration_layergroups = [41],
...
def new_ECalEndcapDigi():
    ...
    """
    return RealisticCaloDigiSilicon("ECalEndcapDigi",
                                    calibration_mip = 0.0001575,
                                    threshold = 5e-05,
                                    thresholdUnit = "GeV",
                                    timingCorrectForPropagation = 1,
...
def new_ECalEndcapReco():
    ...
    """
    return RealisticCaloRecoSilicon("ECalEndcapReco",
                                    calibration_factorsMipGev = [0.00641222630095],
                                    calibration_layergroups = [41],
