...
def new_HCalBarrelDigi():
    ...
    """
    return RealisticCaloDigiScinPpd("HCalBarrelDigi",
...
def new_HCalBarrelReco():
    ...
    """
    return RealisticCaloRecoScinPpd("HCalBarrelReco",
...
def new_HCalEndcapDigi():
    ...
    """
    return RealisticCaloDigiScinPpd("HCalEndcapDigi",
...
def new_HCalEndcapReco():
    ...
    """
    return RealisticCaloRecoScinPpd("HCalEndcapReco",
...
def new_HCalRingDigi():
    ...
    """
    return RealisticCaloDigiScinPpd("HCalRingDigi",
                                    calibration_mip = 0.0004725,
                                    threshold = 0.5,
                                    thresholdUnit = "MIP",
                                    #timingCorrectForPropagation = 1,
...
def new_HCalRingReco():
    ...
    """
    return RealisticCaloRecoScinPpd("HCalRingReco",
                                    calibration_factorsMipGev = [0.0285819096797],
                                    calibration_layergroups = [100],
                                    ppd_mipPe = 15.0,
                                    ppd_npix = 2000,
